  ...
  <v-container class="fill-height pa-0" fluid>
    <v-row no-gutters class="fill-height">
      ...
      <v-col
        cols="12"
        md="7"
        class="bg-blue d-flex flex-column align-center justify-center pa-4"
      >
        <div class="text-center">
          <v-img
            ...
            class="mb-8"
          ></v-img>
          <h1 class="text-h5 text-md-h4 font-weight-bold text-white mb-4">
      ...
      <v-col cols="12" md="5" class="d-flex align-center justify-center pa-4">
        <v-card class="elevation-12" width="100%" max-width="450px">
