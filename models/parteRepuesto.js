...
module.exports = (sequelize, DataTypes) => {
    const ParteRepuesto = sequelize.define('ParteRepuesto', {
        ...
        cantidad_minima: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0, validate: { min: 0 } },
        ...
        // --- CAMPO AÑADIDO ---
        // Guardará la ruta al archivo de imagen o documento asociado a la parte.
        imagen_url: {
            type: DataTypes.STRING,
            allowNull: true,
            comment: 'URL o ruta del archivo de imagen/documento de la parte.'
        },
